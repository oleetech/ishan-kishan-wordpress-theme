...
<html lang="en">
  ...
  <header
    ...
    >
      ...
      <nav
        class="flex relative h-auto max-lg:hidden flex-wrap gap-10 items-start my-auto text-2xl font-semibold leading-tight text-white max-md:max-w-full"
      >
        <a
    ...
    <div id="bgCarousel" class="absolute inset-0 z-[-1] top-0 h-[100vh]">
      <!-- Background images will be inserted here by JavaScript -->
    </div>
    <section class="pt-0 bg-transparent relative overflow-hidden h-[95vh]">
      <div
      ...
      >
        ...
        >
          ...
          >
            <h1
              class="self-stretch text-7xl leading-[80px] text-white max-md:max-w-full max-md:text-4xl max-md:leading-[53px]"
            >
              Empowering Agriculture, <br />
              Nurturing Nature.
            </h1>
            <p class="mt-12 text-white max-md:mt-10 max-md:max-w-full">
              Your trusted partner for sustainable agro-based products and
              solutions.
            </p>
            <a
              href="#"
              class="flex overflow-hidden gap-4 justify-center items-center py-2 pr-1.5 pl-5 mt-20 text-white bg-lime-900 min-h-[58px] rounded-[50px] max-md:mt-10 bg-gradient-to-r from-[#00cd52] to-[#009d1d] text-white"
            >
              <span class="self-stretch max-md:text-base my-auto"
